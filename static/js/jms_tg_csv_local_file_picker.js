...
(function (global) {
    ...
    /**
     * 打开本地文件对话框，一次性读取 CSV 文本并尽力返回绝对路径。
     * @param {HTMLInputElement|null} fallbackInput 不支持 FSA 时的隐藏 file input
     * @returns {Promise<{file:File,content:string,absolutePath:string}|null>}
     */
    function pickTgCsvLocalFile(fallbackInput) {
    ...
    global.JmsTgCsvLocalFilePicker = {
        ...
        pickTgCsvLocalFile: pickTgCsvLocalFile
    };
