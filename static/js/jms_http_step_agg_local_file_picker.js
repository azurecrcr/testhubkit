/**
 * HTTP 步骤 · 聚合报告监听器 · 本地选结果文件（不自动生成路径）
 */
(function (global) {
    'use strict';
    ...
    function pickHttpStepAggLocalFile(fallbackInput) {
