/**
 * 线程组 BeanShell · 本地选脚本文件（不经过服务端上传）
 */
(function (global) {
    'use strict';
    ...
    function pickTgBeanshellLocalScript(fallbackInput) {
    ...
    global.JmsTgBeanshellLocalFilePicker = {
        ...
        pickTgBeanshellLocalScript: pickTgBeanshellLocalScript
    };
