/**
 * HTTP 步骤级配置元件 · HTTP 请求默认值 JMX 与数据规范化（隔离模块）
 */
(function (global) {
    'use strict';
    ...
    function genHttpDefaultsXml(hd, pad, escapeXml) {
        ...
        if (global.JmsStepHttpDefaultsAdvanced && typeof global.JmsStepHttpDefaultsAdvanced.genXml === 'function') {
            xml += global.JmsStepHttpDefaultsAdvanced.genXml(hd, p2, escapeXml);
        }
